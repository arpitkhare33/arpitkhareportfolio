  ...
  return (
    <section id="skills" className="py-20 bg-slate-50">
      <div className="container px-4 md:px-6 mx-auto">
        ...
        >
          <h2 className="text-3xl font-bold tracking-tight mb-4 text-blue-700">Skills & Expertise</h2>
              ...
              <Card className="h-full hover:shadow-lg transition-shadow bg-white">
                <CardContent className="p-6">
                  <div className="flex items-center mb-4">
                    {category.icon}
                    <h3 className="text-xl font-semibold ml-3 text-blue-700">{category.title}</h3>
                  </div>
